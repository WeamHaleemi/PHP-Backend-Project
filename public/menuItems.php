...
<head>
    ...
    <title><?php echo getMenuName($id) ?></title>
</head>
...
<body>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row menu-item-header">
                <h2><?php echo getMenuName($id) . ':'; ?></h2>
                        ...
                        <div class="footer-content-bottom">
                            <div class="footer-center-content">
                                ...
                                <div>
                                    ...
                                    <p class="location-bottom"> Hadath, Beirut, Lebanon</p>
